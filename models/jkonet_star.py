...
class JKOnetStar(LearningDiffusionModel):
    ...
    def create_state_from_params(self, potential_params, internal_params, interaction_params):
    ...
    def _loss_potential_term(self, potential_params, xs, ys, ws, rho, rho_grad):
        # need potential_state as parameter to compute the gradient
        return network_grad(self.model_potential, potential_params)(ys)
    
    def _loss_internal_term(self, internal_params, xs, ys, ws, rho, rho_grad):
    ...
    def _loss_interaction_term(self, interaction_params, xs, ys, ws, rho, rho_grad):
    ...
    def loss(self, potential_params, internal_params, interaction_params, xs, ys, ws, rho, rho_grad):
...
class JKOnetStarPotentialInternal(JKOnetStar):
    def loss(self, potential_params, internal_params, xs, ys, ws, rho, rho_grad):
...
class JKOnetStarPotential(JKOnetStarPotentialInternal):
    def loss(self, potential_params, xs, ys, ws, rho, rho_grad):
        # need potential_state as parameter to compute the gradient
        return jnp.sum(ws * jnp.sum((self.tau * (
...
class JKOnetStarLinear(LearningDiffusionModel):
    ...
    def create_state_from_params(self, potential_params, interaction_params, internal_params):
        return(
            potential_params,
            interaction_params,
            internal_params,
    ...
    def train_step(self, _, all_samples):
